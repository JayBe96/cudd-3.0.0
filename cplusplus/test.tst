...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x509";
}
}
"  s0  " -> "0x586" [style = solid];
"  s1  " -> "0x588" [style = solid];
"  s2  " -> "0x58a" [style = solid];
"  c3  " -> "0x58b" [style = solid];
"0x58b" -> "0x510";
"0x58b" -> "0x589" [style = dashed];
"0x58a" -> "0x589";
"0x58a" -> "0x589" [style = dotted];
"0x510" -> "0x509";
"0x510" -> "0x509" [style = dotted];
"0x589" -> "0x542";
"0x589" -> "0x587" [style = dashed];
"0x588" -> "0x587";
"0x588" -> "0x587" [style = dotted];
"0x542" -> "0x509";
"0x542" -> "0x509" [style = dotted];
"0x587" -> "0x561";
"0x587" -> "0x585" [style = dashed];
"0x586" -> "0x585";
"0x586" -> "0x585" [style = dotted];
"0x561" -> "0x509";
"0x561" -> "0x509" [style = dotted];
"0x585" -> "0x509";
"0x585" -> "0x509" [style = dotted];
"0x509" [label = "1"];
}
